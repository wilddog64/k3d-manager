...
# Setup Vault CA Certificate Export - Universal SSL Trust Configuration
#
...
main() {
  ...
  show_install_instructions "$EXPORT_PATH"

  # Show service-specific usage
  show_service_usage "$EXPORT_PATH"
