# v1.6.6 — `k3s-hostinger` provider (single-node app cluster on a permanent VPS)

**Branch:** `k3d-manager-v1.6.6`
...
- [ ] Committed and pushed to `k3d-manager-v1.6.6`
...
- Do NOT commit to `main` — work on `k3d-manager-v1.6.6`
