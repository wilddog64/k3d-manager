...
| `deploy_shopping_cart_data` | `scripts/plugins/shopping_cart.sh` | Deploy PostgreSQL (orders/payment/products), Redis cart, RabbitMQ, and MinIO data services; apply Vault-backed ExternalSecrets; wait for readiness |
