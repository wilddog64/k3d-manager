...
- [ ] **ACG credentials timeout values + _waitForSandboxEntry arg-slot bug** — OPEN. lib-acg spec: `docs/plans/bugfix-acg-credentials-timeout-values.md`, branch `fix/acg-credentials-timeout-values`. Assigned to Codex.
