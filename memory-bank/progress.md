...
- [ ] **ACG credentials 30s timeout** — OPEN. lib-acg spec: `docs/plans/bugfix-acg-credentials-waitforfunction-timeout.md`, branch `fix/acg-credentials-waitforfunction-timeout`. Assigned to Codex.
