...
- [ ] **Hostinger shopping-cart workloads orphaned** — no `ubuntu-hostinger-*` Applications / cluster Secret on the hub; pods still Running on srv1754834. Needs user decision (re-register or retire). (found 2026-09-13)
