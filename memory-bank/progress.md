...
- [ ] **Gemini: vault-bridge e2e** — ASSIGNED 2026-04-03. User running deploy manually. Verify socat systemd active, vault-bridge Endpoints, ClusterSecretStore `Ready`, all 5 pods Running.
