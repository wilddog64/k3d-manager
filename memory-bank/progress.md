...
| Second chooser click intercepted by overlay div.dKGsO (live test) | OPEN | `docs/bugs/v1.1.0-bugfix-gcp-login-second-chooser-force-click.md`; click({ force: true }) + 2s wait |
