...
- [ ] **Bug: `bin/smoke-test-cluster-health` stale defaults** — APP_CONTEXT `ubuntu-k3s` + pre-rename app names; exits 1 silently at ArgoCD step. Needs spec. (found 2026-09-13 live smoke)
- [ ] **Drift: `hub-platform-ops` perpetually OutOfSync on ES `platform-ops/app-cluster-kubeconfig`** after Succeeded sync — investigate ignoreDifferences/defaulted fields.
