...
- [~] **Live E2E failure-groups table follow-up 2026-09-16.** Platform-ops was applied and exporter restarted, but the live exporter still emitted no `e2e_failure_group_info` for the backfilled newest event and fell back to the ConfigMap name/empty dimensions. Latest sidecar groups are documented in `docs/issues/2026-09-16-live-e2e-failure-groups-empty.md`; exporter refresh parsing needs a focused fix before claiming live completion.
