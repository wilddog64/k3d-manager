...
- [x] **Hermes findings visibility (`60a04c19`, follow-up pending)** — Added redacted status publication, exporter metrics, and the dedicated Hermes Status Grafana dashboard. The feed also publishes regular sensors while optional `status_checks` is disabled. Pytest Hermes 106 passed; observability BATS 15/15; shellcheck and `_agent_audit` clean.
