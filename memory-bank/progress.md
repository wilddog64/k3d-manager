...
- [ ] **GCP IAM auto-grant** — **ABANDONED** (2026-04-12). All technical paths (CLI, API, Playwright) failed due to hard platform restrictions in the ACG GCP Sandbox. Strategy shifted to manual verification only.
