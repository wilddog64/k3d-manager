...
- [x] **2026-09-15 — Alertmanager sms-critical SMTP send verified** — test alert after pod restart; email notifications_total=1, failed=0 at 00:25:58Z; phone receipt pending user confirmation
