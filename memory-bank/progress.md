...
- [ ] **Start Sandbox Disabled Timeout** — ASSIGNED TO GEMINI. Bug `docs/bugs/2026-04-23-acg-start-sandbox-button-disabled-timeout.md`; add `isEnabled()` guard before `startButton.click()` in `acg_credentials.js`; assigned 2026-04-23.
