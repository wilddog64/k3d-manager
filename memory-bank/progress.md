...
- [ ] Hub ArgoCD foreign chart ownership (`docs/bugs/2026-09-13-hub-argocd-foreign-chart-ownership-blocks-helm-upgrade.md`) — spec'd 2026-09-13, ASSIGNED Codex; live `--confirm` + helm upgrade = operator go
- [ ] Hub federate-acg self-scrape duplicates (`docs/bugs/2026-09-13-hub-federate-acg-self-scrape-duplicates-series.md`) — spec'd 2026-09-13, ASSIGNED Codex; live observability AppSet reapply (scoped) + dashboard apply = operator go
