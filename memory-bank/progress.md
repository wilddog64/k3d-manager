...
- [ ] **Phase C — GCP identity (`gcp.sh`)** — SPEC `docs/bugs/v1.1.0-recovery-phase-c-gcp-identity.md`. Implements **Credential Scrubbing** (secure file pattern) to prevent stdout leak and surgical latch-on identity pattern.
