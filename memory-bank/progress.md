...
- [ ] Hub federate-acg self-scrape duplicates (`docs/bugs/2026-09-13-hub-federate-acg-self-scrape-duplicates-series.md`) — spec'd 2026-09-13, re-dispatched to Codex (commit-only, Claude pushes); live observability AppSet reapply (scoped) + dashboard apply = operator go
