...
- [ ] **Hermes SMS pager** — IMPLEMENTED (Codex) — awaiting Claude verification; commit `a18450d4`; plan `docs/plans/v1.34.0-hermes-sms-pager.md`; assigned to Codex 2026-09-15 (codex exec). Operator follow-ups: provision 3 `k3dm-hermes-sms-*` Keychain items; re-mint `k3dm-hermes-argocd-token` (ArgoCD reinstall 2026-09-10 invalidated it).
