...
- [x] **ACG repo extraction phase 1** — COMPLETE (`20df717c`). Spec `docs/plans/v1.2.0-phase1-gemini-rename.md`; renamed the plugin and how-to entry points to `gemini`, updated checked-path references, and left the remaining lib-acg phases planned.
