...
- [x] **E2E run identity labels** — Recent runs now distinguishes runner/orchestration commit from application image digest and test suite, removing ambiguity around the former `Commit`/`Project` labels.
