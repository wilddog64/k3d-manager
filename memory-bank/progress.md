...
- [ ] **Teardown State Drift** — OPEN. Issue `docs/bugs/2026-04-23-acg-down-should-reset-local-and-remote.md`; `acg-down` currently preserves local Hub state, which delays detection of stale-state drift across repeated remote rebuilds.
