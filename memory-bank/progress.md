...
| Continue not clicked after second chooser — consent page blocks Allow | OPEN | `docs/bugs/v1.1.0-bugfix-gcp-login-continue-after-second-chooser.md`; page body confirmed CancelContinue; second Continue handler needed |
| Live smoke test `make up CLUSTER_PROVIDER=k3s-gcp GHCR_PAT=<pat>` | PENDING | After post-chooser Continue fix |
