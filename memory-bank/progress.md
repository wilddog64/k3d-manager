...
| Version | Theme | State |
|---|---|---|
| v1.25.0 | lifecycle, observability, CVE remediation, Slack, and Tier 1 E2E harness | RELEASED — PR #116 merged as `d48e465f`, tag/release `v1.25.0`; branch protection restored |
