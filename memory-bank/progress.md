...
- [ ] Hermes↔Slack approval (Option A) — decisions resolved 2026-09-13 (user): all 5 code slices in v1.33.0, off until `K3DM_HERMES_APPROVAL_DRAIN_URL` set; worker drain endpoint; next-poll latency; Deny = dismiss only. Impl spec §13 of `docs/plans/v1.33.0-hermes-slack-approval.md` (`0a4eba22`). DISPATCHED to Codex 2026-09-13. Live KV/secrets/Slack interactivity + E2E = operator steps.
