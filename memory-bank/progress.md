...
| `gcp_login` password input timeout — session already authenticated | OPEN | `docs/bugs/v1.1.0-bugfix-gcp-login-password-step-optional.md`; persistent context skips password; hard waitFor times out |
