...
## PENDING
- [ ] **istio-cni conf/bin dir mismatch — NEXT blocker (live-confirmed 2026-07-19), ASSIGNED to Codex 2026-07-19 (awaiting SHA).** ztunnel `ContainerCreating`: `failed to find plugin "istio-cni"`. Already specced `docs/bugs/2026-07-17-ambient-istio-cni-conf-bin-dir-mismatch.md` (spec hardened `67b48935`); repo file unpatched. Last blocker before ambient dataplane green on k3s-aws → then hostinger rebuild.
