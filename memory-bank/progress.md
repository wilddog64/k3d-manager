...
- [x] **2026-09-15 — Alertmanager sms-critical SMS end-to-end VERIFIED** — Gmail App Password fix; text received by user; Keychain backup of App Password = user action
