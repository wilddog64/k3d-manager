...
- [ ] **Bugfix: `acg-up` empty PAT guard** — OPEN. Spec: `docs/bugs/v1.4.1-bugfix-acg-up-empty-pat-guard.md`. Assigned to Codex. Fix: guard empty `_ghcr_pat` before namespace loop in `bin/acg-up`.
