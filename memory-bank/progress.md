...
| Version | Theme | State |
|---|---|---|
| v1.25.0 | lifecycle, observability, CVE remediation, Slack, and Tier 1 E2E harness | PR #116 open at `08b49354`; Copilot findings resolved; CI green; approval-count override active pending merge |
...
- [x] **hostinger edge recovery — narrow entrypoint IMPLEMENTED** (2026-08-16, commit `f28b6cda`). Edge went
