...
- [ ] v1.34.0 follow-up: BATS bare `!` negations never fail mid-test — SPEC'D 2026-09-14 `docs/bugs/2026-09-14-bats-bare-negation-assertions-never-fail.md` (42 lines/14 files, 13 mid-test, signing.bats:124 guard can never fail; + lint test). Codex queue #3.
