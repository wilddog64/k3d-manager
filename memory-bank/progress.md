...
- [x] **Hermes findings visibility (`pending commit`)** — Added redacted status publication, exporter metrics, and the dedicated Hermes Status Grafana dashboard. Pytest Hermes 106 passed; observability BATS 15/15; shellcheck and `_agent_audit` clean.
