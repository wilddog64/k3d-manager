...
| `gcp_login` second account chooser on signin/oauth/id (live test) | OPEN | `docs/bugs/v1.1.0-bugfix-gcp-login-second-account-chooser.md`; AccountChooser in body; div[data-identifier] click needed before Allow |
| Live smoke test `make up CLUSTER_PROVIDER=k3s-gcp GHCR_PAT=<pat>` | PENDING | After second-chooser fix |
