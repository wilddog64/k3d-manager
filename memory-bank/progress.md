...
| Keycloak plugin missing | FIXED | 2026-03-03: `deploy_keycloak` plugin added with Vault/LDAP integrations and Bats coverage. **2026-03-04:** `$KEYCLOAK_LDAP_USERS_DN` envsubst whitelist expaned per Gemini R2. |
