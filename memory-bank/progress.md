...
- [x] **GCP IAM auto-grant** — HYBRID STRATEGY (2026-04-12). Replaced full automation with "Manual Bridge" flow. Gemini performs extraction; user performs one-time login in Chrome; Gemini "latches on" via CDP to automate final IAM table interactions. Strategy documented in `docs/issues/2026-04-12-gcp-iam-automation-constraints.md`.
