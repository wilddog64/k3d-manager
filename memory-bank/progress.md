...
- [ ] **ESO webhook readiness race** — OPEN. Bug `docs/bugs/2026-04-24-eso-webhook-readiness-race.md`; `deploy_eso` waits for the main controller but not the validating webhook endpoint, allowing LDAP ExternalSecret admission to fail during fresh Hub bootstrap.
