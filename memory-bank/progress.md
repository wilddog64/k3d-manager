...
- [ ] **Keycloak frontend login** — spec: `docs/plans/v1.4.3-keycloak-frontend-login.md`; `frontend` OIDC client + Vault ESO for Keycloak secrets; two-repo: shopping-cart-infra (`feat/keycloak-vault-eso`) + k3d-manager; assigned to Gemini
