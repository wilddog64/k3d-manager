...
- [ ] **Phase B — Robot engine unification** — SPEC `docs/bugs/v1.1.0-recovery-phase-b-robot-engine.md`. Handed off to Gemini 2026-04-19. `acg_credentials.js`: `.close()`→`.disconnect()` for CDP; `--provider aws|gcp` flag; 127.0.0.1 CDP host; timer cleanup + explicit `process.exit(0)`.
