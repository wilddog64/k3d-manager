...
- [ ] **Codex: hub recovery automation specs (v1.33.0, DISPATCHED 2026-09-13 via codex exec, sequential A→B→C; A DONE `b71e587a`, B+C pending)** — `docs/bugs/2026-09-13-hub-recovery-manual-fixes-not-declarative.md` (`hub_recovery_reconcile`), `docs/bugs/2026-07-17-ambient-istio-cni-conf-bin-dir-mismatch.md` §Spec 2026-09-13, `docs/bugs/2026-09-13-grafana-port-forward-plist-overwritten-by-acg-writers.md`. Verify each SHA on origin before trusting.
