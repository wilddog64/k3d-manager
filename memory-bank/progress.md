...
- [ ] **GCP IAM auto-grant** — **HYBRID+ STRATEGY** (`docs/plans/v1.1.0-gcp-iam-hybrid-plus.md`). Manual Bridge + Automated Consent flow to bypass bot detection and API restrictions.
