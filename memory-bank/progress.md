...
- [ ] v1.34.0 operator: `make restart-webhook`; `make observability`; `make platform-ops` + manual argocd-cve-scan job; release AppSet reapply (live-preserving) + `argocd_check_values_branch`.
