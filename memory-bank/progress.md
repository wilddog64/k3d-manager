...
- [ ] **Bug 11 — acg-down keep-hub preservation trust gap** — `bin/acg-down` still needs explicit resolved Hub logging and a conditional completion message so `--keep-hub` is unambiguous to operators.
