...
- [ ] **Gemini: vault-bridge e2e** — BLOCKED on bin/ SCRIPT_DIR fix. Run `bin/acg-up` on fresh sandbox; verify socat systemd active, ClusterSecretStore `Ready`, all 5 pods Running. Spec DoD: `docs/plans/v1.0.2-bugfix-vault-bridge.md`.
