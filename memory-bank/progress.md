...
## Status
- **k3d-manager v1.4.6 acg-credentials handler animation settle ASSIGNED** — spec: `docs/bugs/2026-05-16-acg-credentials-extend-modal-handler-animation-settle.md`; add `await page.waitForTimeout(1000).catch(() => {})` at end of handler callback; branch: `k3d-manager-v1.4.6`
