...
## Status
- **v1.4.11 PARTIALLY COMPLETE** (2026-05-29) — Keycloak sub-flow fix merged (`4c7c6ec`); data-layer StatefulSet race fix applied locally; ArgoCD RBAC fix and Node.js 20→22 upgrade pending.
