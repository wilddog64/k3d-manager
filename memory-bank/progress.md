...
- [ ] **Phase C — GCP identity (`gcp.sh`)** — **IN PROGRESS (Blocked by `bin/acg-up`)**. Issue `docs/bugs/2026-04-20-acg-up-monolithic-aws-lock.md`. Implemented **Credential Scrubbing** and surgical latch-on, but entry point is currently hardcoded to AWS.
