...
- [ ] **Gemini: vault-bridge e2e** — ASSIGNED 2026-04-03. Unblocked by `29a8535`. Run `bin/acg-up` end-to-end; verify socat systemd active, vault-bridge Endpoints, ClusterSecretStore `Ready`, all 5 pods Running.
