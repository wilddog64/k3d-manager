...
## Next Steps (v1.4.5)
- [ ] **ArgoCD SSO via Keycloak** — ASSIGNED TO GEMINI; spec: `docs/plans/v1.4.5-argocd-sso-keycloak.md`; k3d-manager `k3d-manager-v1.4.5` + shopping-cart-infra `docs/next-improvements`
