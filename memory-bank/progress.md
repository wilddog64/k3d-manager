...
- [ ] **Bug: keycloak.sh leaked RETURN trap → `hub_recovery_reconcile --confirm` rc=1 `wd: unbound variable`** (all steps succeeded) — spec `docs/bugs/2026-09-13-keycloak-leaked-return-trap-unbound-wd.md`, READY FOR CODEX.
