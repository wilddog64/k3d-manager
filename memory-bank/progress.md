...
- [ ] **Phase C — GCP identity (`gcp.sh`)** — **IN PROGRESS (Blocked by `bin/acg-up`)**. Issue `docs/bugs/2026-04-20-acg-up-monolithic-aws-lock.md`. Implemented credential scrubbing and surgical latch-on; entry point fix spec at `docs/bugs/2026-04-20-acg-up-provider-dispatch.md` — **HANDED OFF TO GEMINI** (2026-04-20).
