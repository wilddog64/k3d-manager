...
- [ ] **Bug: hub restore leaves no Vault `secret/argocd/admin` (show-service-passwords ArgoCD N/A)** — spec `docs/bugs/2026-09-13-hub-restore-argocd-admin-vault-mirror-missing.md`, DISPATCHED to Codex 2026-09-13.
