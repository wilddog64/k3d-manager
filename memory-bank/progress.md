...
- [ ] **acg-sync-apps + acg-status dual-cluster** — SPEC READY. Spec `docs/bugs/2026-04-23-acg-sync-apps-and-acg-status-dual-cluster.md`; assigned to Codex 2026-04-23. Poll port-forward readiness; configurable `ARGOCD_APP`; Hub section in `acg-status`.
