...
- [ ] **GCP Provisioning Error 1** — ASSIGNED TO GEMINI. Bug `docs/bugs/2026-04-23-gcp-node-readiness-timeout-bash-pitfall.md`; `(( attempts++ ))` → `(( ++attempts ))` at lines 109 + 211 of `k3s-gcp.sh`. Spec complete; assigned 2026-04-23.
