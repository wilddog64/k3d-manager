...
- [ ] **`make update-webhook-slack-secret` argv + fail-open** — spec `docs/bugs/2026-09-15-update-webhook-slack-secret-argv-fail-open.md`; assigned to Codex 2026-09-15 (codex exec).
