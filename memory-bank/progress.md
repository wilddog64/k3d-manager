...
- [ ] **2026-09-15 — Alertmanager sms-critical SMTP send FAILING** — Gmail `534 5.7.9 Application-specific password required`; user to set App Password via `make alertmanager-secret`, then retest
