...
- **`gcp_get_credentials` CDP warn + restart** — OPEN | `docs/bugs/v1.1.0-bugfix-gcp-cdp-warn-and-restart.md`; when Chrome running without CDP, print 3 `_info` lines + 5s countdown, then kill + relaunch. Ctrl+C to abort. Chrome restores tabs via session restore.
