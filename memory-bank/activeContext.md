...
- **2026-09-17 — Hermes findings visibility implemented.** Hermes publishes a redacted status ConfigMap; the platform exporter emits Hermes sensor/check/incident metrics; and a dedicated `Hermes Status` Grafana dashboard shows current findings, poll age, incident state, and history. Design/acceptance record: `docs/issues/2026-09-17-hermes-grafana-visibility.md`.
