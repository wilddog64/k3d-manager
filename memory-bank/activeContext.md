...
- **OPEN Bug 14 — Keycloak `argocd` client redirect reconciliation** — `bin/acg-up` skips realm import on `409`, leaving stale redirect URIs in existing Keycloak clients and breaking Argo CD SSO after rebuilds. Spec: `docs/bugs/2026-05-11-keycloak-argocd-client-redirect-reconciliation.md`.
