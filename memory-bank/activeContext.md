...
- **Status:** PART 1 (Credentials) failed due to isolated profile requiring manual login and aggressive timeouts. Timeouts in `acg_credentials.js` have been increased to 10m total. Documented in `docs/issues/2026-04-03-acg-credentials-auth-blockers.md`.
