...
**Current task:** `_antigravity_ensure_acg_session` — **E2E FAILED**. Implemented in `scripts/plugins/antigravity.sh`; BATS coverage passed; E2E live test failed due to `gemini` CLI `RESOURCE_EXHAUSTED` (API capacity). Issue doc created: `docs/issues/2026-03-27-acg-session-e2e-fail.md`.
