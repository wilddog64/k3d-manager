...
| `acg_credentials.js` Cloudflare bot-check page hangs credential extraction | OPEN | `docs/bugs/v1.1.0-bugfix-acg-credentials-cloudflare-challenge.md`; assigned to Codex |
