...
- **`gcp_get_credentials` CDP warn + restart** — COMPLETE (`1b038b52`) | `docs/bugs/v1.1.0-bugfix-gcp-cdp-warn-and-restart.md`; `scripts/plugins/gcp.sh` now warns with 3 `_info` lines, waits 5 seconds for Ctrl+C, then restarts Chrome with CDP so `make up` stays automated.
