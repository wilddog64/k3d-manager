...
| C — gcp.sh | **PARTIAL / BLOCKED** | `docs/bugs/2026-04-20-acg-up-monolithic-aws-lock.md` | `scripts/plugins/gcp.sh`, `bin/acg-up` | `feat(gcp): add plugin and refactor entry point for multi-cloud` |
