...
- **Teardown State Drift** — OPEN (`docs/bugs/2026-04-23-acg-down-should-reset-local-and-remote.md`). `acg-down` preserves the local Hub by default, which hides stale local state across repeated remote rebuild cycles.
