...
| C — gcp.sh | **PARTIAL / BLOCKED** | `docs/bugs/2026-04-20-gcp-provider-unsupported-in-core.md` | `scripts/lib/core.sh` | `feat(gcp): plugin ready, core dispatcher needs k3s-gcp allowlist` |
