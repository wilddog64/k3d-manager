...
| vCluster E2E composite actions | **PR #34 open — mktemp/dependency fixes pushed** | curl+validation fixed (`05ea15c`); `3079f83` adds mktemp+trap installer and teardown dependency guard per `docs/plans/v0.9.2-vcluster-composite-action-mktemp-fix.md`. |
