...
- **2026-09-16 — E2E table labels clarified (pending commit).** Recent runs now labels the source revision as `Runner commit`, the tested image as `Application image digest`, the service as `Service under test`, and `api+flows` as `Test suite`.
