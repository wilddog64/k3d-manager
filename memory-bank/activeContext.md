...
- **GCP pre-flight stale project bug** — OPEN (`docs/bugs/2026-04-13-gcp-preflight-stale-project.md`). Cached SA key points to expired sandbox project; `_gcp_load_credentials` needs `gcloud projects describe` probe before skipping Playwright.
