...
| Detect Pluralsight /id redirect and throw actionable session-expiry error | OPEN | `docs/bugs/v1.1.0-bugfix-acg-credentials-session-expiry-detection.md`; assigned to Codex |
