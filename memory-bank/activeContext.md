...
| Wait for manual sign-in at `/id` instead of throwing immediately | OPEN | `docs/bugs/v1.1.0-bugfix-acg-credentials-id-redirect-wait-for-login.md`; assigned to Codex |
