...
- **Teardown State Drift** — SPEC READY (`docs/bugs/2026-04-23-acg-down-full-teardown-spec.md`). Impl spec written 2026-04-23; assigned to Codex. `acg-down` to tear down Hub by default; `--keep-hub` opt-out added.
