...
- **2026-09-16 — E2E failure table column order (working tree).** Failure groups and Failure details now put Run ID and Runner first, matching Recent runs for quick correlation.
