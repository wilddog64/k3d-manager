...
| Continue not clicked after second chooser — consent page blocks Allow | OPEN | `docs/bugs/v1.1.0-bugfix-gcp-login-continue-after-second-chooser.md`; page body shows CancelContinue after chooser; need second Continue handler inside secondChooserVisible block |
