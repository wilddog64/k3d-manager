...
- **2026-09-13 — Codex: `_signing_grant_eso_read` false-success fix** — spec `docs/bugs/2026-09-13-signing-grant-eso-read-false-success.md`; Codex `58999f55`; Claude verified (3 files, shellcheck no new, BATS 37/37) and pushed — DONE. Hub cosign ES SecretSynced; hostinger pending force-sync. Operator: hostinger grant must run with context `ubuntu-hostinger`.
