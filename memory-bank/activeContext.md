...
- **CDP guidance log** — COMPLETE (`bf00be14`) | `docs/bugs/v1.1.0-bugfix-acg-credentials-cdp-guidance-log.md`; `scripts/playwright/acg_credentials.js` now logs that a new Chrome window will open and tells the user to log in there or restart Chrome with `--remote-debugging-port=9222`.
