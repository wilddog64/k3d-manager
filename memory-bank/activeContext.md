...
- **OPEN Bug 11 — acg-down keep-hub preservation trust gap** — `bin/acg-down --confirm --keep-hub` needs explicit resolved Hub logging and a conditional completion message so the preserved-Hub path is unambiguous. Spec: `docs/bugs/2026-05-11-acg-down-keep-hub-preservation.md`.
