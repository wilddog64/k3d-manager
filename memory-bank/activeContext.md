...
**v1.0.2 ACTIVE** — branch `k3d-manager-v1.0.2` cut from `a8b6c583` 2026-03-31. e2e verified 2026-04-03: `make up` runs 12 steps end-to-end, ClusterSecretStore Ready, 3 nodes Ready. Fixes: vault-root key (`root_token`), GHCR_PAT auto-populate, CDP browser `close()`. Commit `82a0376`. PR ready to cut.
