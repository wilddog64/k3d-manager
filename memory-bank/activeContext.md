...
- **ACG Credentials Observability Gap** — COMPLETE (`<SHA>`). Granular state machine and reserved exit codes implemented in acg_credentials.js; acg.sh surfaces specific error modes.
