...
| Add text-based button fallback when data-heap-id selectors don't match | OPEN | `docs/bugs/v1.1.0-bugfix-acg-credentials-button-click-fallback.md`; assigned to Codex |
