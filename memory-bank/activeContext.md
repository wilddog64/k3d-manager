...
**FIX PUSHED 2026-08-16:** commit `8ea02b51` is pushed to `origin/k3d-manager-v1.25.0`; both exact label edits passed the Kustomize and YAML parse gates. No live deployment was performed.
