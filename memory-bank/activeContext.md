...
| **Gemini e2e smoke test (run 3)** | **PENDING** | Verify hotfixes: keypair import silent on duplicate; `antigravity_acg_extend` navigates unconditionally; full lifecycle clean. |
