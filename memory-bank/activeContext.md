...
| C — gcp.sh | **HANDED OFF TO GEMINI** (2026-04-20) | `docs/bugs/v1.1.0-recovery-phase-c-gcp-identity.md` | `scripts/playwright/acg_credentials.js` (Part 1), `scripts/plugins/gcp.sh` new (Part 2) | `feat(gcp): add plugin with surgical latch-on and credential scrubbing` |
