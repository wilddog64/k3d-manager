...
- **Start Sandbox Disabled Timeout** — OPEN (`docs/bugs/2026-04-23-acg-start-sandbox-button-disabled-timeout.md`). Playwright fails to click "Start Sandbox" because it is `disabled`. RCA identifies a latching logic gap. Found 2026-04-23.
