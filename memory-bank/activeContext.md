...
- **GCP provider post-review bugfix** — ASSIGNED to Codex (`docs/plans/v1.0.7-bugfix-gcp-provider-fixes.md`). Five issues from review of `1c620795`: missing `--image-family=ubuntu-2204-lts --image-project=ubuntu-os-cloud` on instance create; wrong k3sup flag `--kubeconfig` → `--local-path`; missing `--k3s-extra-args="--disable=traefik"`; destroy doesn't clean up kubeconfig context; `gcp.sh` exports before validating extracted values.
