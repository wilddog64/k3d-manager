...
- **COMPLETE:** `fix(acg-up)` — removed the macOS Safari auto-open entirely so `make up` finishes bootstrap without launching a browser. Issue doc: `docs/issues/2026-05-12-acg-up-browser-auto-open-removed-for-noninteractive-flows.md`.
