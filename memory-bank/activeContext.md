...
**Current task:** Pin gemini model to `gemini-1.5-flash` — **IMPLEMENTED**. Updated `scripts/plugins/antigravity.sh` with `--model gemini-1.5-flash` in 5 call sites. BATS tests pending Codex implementation.
