...
- **ACG CDP/session mismatch** — RESOLVED (`5b6d030e`). Issue `docs/bugs/2026-04-19-acg-credentials-current-blocker-cdp-session-mismatch.md`; unified orchestration resolves the attachability mismatch.
- **ACG CDP/session contract** — COMPLETE (`5b6d030e`). Added unified Chrome/CDP helper in `scripts/plugins/acg.sh`; `gcp.sh` now delegates to it.
