...
| C — gcp.sh | **COMPLETE** (impl `5cb4c68c`, Gemini) | `docs/bugs/2026-04-20-acg-up-provider-dispatch.md` | `bin/acg-up` | `fix(acg-up): provider-aware dispatch — unblock k3s-gcp make up` |
