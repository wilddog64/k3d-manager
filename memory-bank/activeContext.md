...
- **IN PROGRESS:** Argo CD browser TLS cleanup now needs to skip revoke when the prior cert is already gone. New issue: `docs/issues/2026-05-11-argocd-browser-tls-revoke-missing-cert.md`.
