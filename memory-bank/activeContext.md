...
## Open Items
- **Vault Sync Mismatch** — CRITICAL BLOCKER (`docs/bugs/2026-04-23-vault-keychain-sync-mismatch.md`). Vault storage and Keychain shards are out of sync; manual "Nuclear Reset" required.
