...
| Button-wait timeout gives no diagnostics — can't tell what page is showing | OPEN | `docs/bugs/v1.1.0-bugfix-acg-credentials-button-wait-diagnostics.md`; assigned to Codex |
