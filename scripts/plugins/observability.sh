...
PY
  ...
  _clusterrole_json="$(_trivy_prom_query "${_context}" 'sum by (name,resource_kind,severity) (trivy_clusterrole_clusterrbacassments{severity=~"High|Critical"}) > 0' 2>/dev/null || true)"
