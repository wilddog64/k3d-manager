...
- [ ] **ACG watcher fails to find Extend button** — OPEN. The watcher logs `ERROR: Extend button not found or not visible after multiple attempts` even though manual extension still works. Likely fix point is `playwright/acg_extend.js`; see `docs/bugs/2026-04-29-acg-watcher-extend-button-not-found.md`.
