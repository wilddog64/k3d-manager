...
export LDAP_USER_OU="${LDAP_USER_OU:-ou=users}"
...
export LDAP_BINDPASS="${LDAP_BIND_PASSWORD}"
...
export LDAP_HOST="${LDAP_HOST:-${LDAP_SERVICE_NAME}.${LDAP_NAMESPACE}.svc.cluster.local}"
...
export LDAP_LDIF_FILE="${LDAP_LDIF_FILE:-${SCRIPT_DIR}/etc/ldap/bootstrap-basic-schema.ldif}"  # Path to custom LDIF file (defaults to bootstrap)
...
export LDAP_BIND_DN_KEY="${LDAP_BIND_DN_KEY:-LDAP_BIND_DN}"
...
export LDAP_ROTATOR_ENABLED="${LDAP_ROTATOR_ENABLED:-1}"
